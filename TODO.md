...
## Article Retrieval
- [ ] Implement multi-source article retrieval (ArXiv, PubMed, CrossRef, etc.)
- [ ] Implement actual API calls for `litrev/retrieval.py`
- [ ] Add support for checking open access versions

## User Interface
- [ ] Build article screening interface
- [ ] Complete QML pages for all steps of the workflow
- [ ] Integrate QML controllers with the UI components

## AI Engine
- [ ] Integrate review generation engine in `litrev/ai.py`
- [ ] Add support for different research methodologies
- [ ] Implement thematic analysis logic

## Editor & Export
- [ ] Add integrated document editor
- [ ] Add export options for PDF and other formats
